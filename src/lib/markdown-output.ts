...
<html lang="en">
  <head>
    ...
    <style>
      ...
      pre[data-code-language]::before { content: attr(data-code-language); position: absolute; top: 0.55rem; left: 1rem; color: #8b949e; font: 600 0.64rem/1.2 ui-monospace, SFMono-Regular, Menlo, monospace; letter-spacing: 0.03em; white-space: nowrap; }
